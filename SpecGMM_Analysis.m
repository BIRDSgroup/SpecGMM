...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% 16S rRNA datasets %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% '16SrRNA_KingdomToPhylum_Bacteria', ...
% '16SrRNA_PhylumToClass_Firmicutes', ...
% '16SrRNA_ClassToOrder_Bacilli', ...
% '16SrRNA_OrderToFamily_Bacillales', ...
% '16SrRNA_FamilyToGenus_Bacillaceae', ...
% '16SrRNA_GenusToSpecies_Bacillus'
